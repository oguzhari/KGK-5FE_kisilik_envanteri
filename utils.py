...
def tanımla_analiz_et(ogrenci):
    envanter_analiz = ""
    arada_kalanlar = []
    envanter_degerlendirme_1_0 = [
        "Sosyal ortamlarda kaygı yaşayabilir.",
    ...
    envanter_degerlendirme_1_1 = [
        "Sosyal ortamlarda sıcak,ortama kolayca dahil olabilir.",
    ...
    envanter_degerlendirme_2_0 = [
        "İnsanlara kolayca güvenebilen, takım çalışmasına kolayca uyum sağlayabilir.",
    ...
    envanter_degerlendirme_2_1 = [
        "Genellikle çatışma ortamından beslenmeye yatkın olabilir.",
        "Her şeye şüphe ile yaklaşabilir.",
        "Olumsuz düşünmeye eğilimi yüksek olabilir.",
    ...
    envanter_degerlendirme_3_0 = [
        "Gerçekleştirmesi gereken işleri ertelemeye eğilimli olabilir.",
        "Plan ve programa uyma eğilimi düşüktür olabilir.",
        "Motivasyonu iş sürecinde düşebilir.",
    ]
    envanter_degerlendirme_3_1 = [
        "Bir işe yoğunlaştığında detaylara dikkat etmeyebilir.",
        "Programa ve hedeflerine yönelik titiz olabilir.",
        "Düzenli, planlı davranma eğilimi yüksektir.",
    ]

    envanter_degerlendirme_4_0 = [
        "Olaylara gerçekçi bakış açısıyla yaklaşabilir.",
        "Duygu durumu sürekli değişmeyen huzurlu olabilir.",
        "Kaygı seviyesini duruma göre ayarlamaya yatkın olabilir.",
    ]
    envanter_degerlendirme_4_1 = [
        "Olumsuz düşünmeye eğilimli, kendini suçlamaya yatkın olabilir.",
    ...
    envanter_degerlendirme_5_0 = [
        "Rutinleri seven, yeniliği tehlike gibi algılamaya eğilimli olabilir.",
        "Geleneksel ve alışılmış olana bağlılık seviyesi yüksektir olabilir.",
    ]
    envanter_degerlendirme_5_1 = [
        "Yenilik gereken alanları, fırsatlarını görme eğilimleri yüksek olabilir.",
        "Farklı değişik deneyimlere açık olma eğilimleri yüksektir.",
        " Farklı ilgi alanlarına eğilimli olabilir.",
    ]

    envanter_degerlendirme_6_0 = [
        "Yeni girdiği ortamda kendini ifade edebilir.",
        "İletişim becerisi yüksek, isteklerini dile getirirken zorlanmaya bilir.",
        "Olumlu düşünmeye eğilimleri yüksek olabilir.",
    ]
    envanter_degerlendirme_6_1 = [
        "Yeni girdiği ortamlarda konuşmak yerine dinlemeyi tercih edebilir.",
        "Duygularını dışavurmaktansa içinde yaşayabilir.",
        "Memnuniyetsizliğini dile getirme konusunda sıkıntı yaşayabilir.",
    ]

    envanter_degerlendirme_7_0 = [
        "Diğer insanlardan önce kendinilerini önemseyebilir.",
        "Karar alırken kendi avantajlarını ön planda tutabilir.",
    ]
    envanter_degerlendirme_7_1 = [
        "Merhametli, insanlara yardım etmekten keyif alabilir.",
        "İşbirliğine eğilimli ve insan ilişkileri güçlü olabilir.",
    ]

    envanter_degerlendirme_8_0 = [
        "Öz disiplin seviyesi yüksek olabilir.",
    ...
    envanter_degerlendirme_8_1 = [
        "Öz disiplin seviyesi biraz düşük olabilir.",
    ...
    envanter_degerlendirme_9_1 = [
        "Aldığı kararlardan emin, kendisi ve çevresi ile uyumlu olabilir.",
        "Problemler karşısında stres seviyelerini kontrol edebilmeye eğilimlidir.",
    ]

    envanter_degerlendirme_10_0 = [
        "Geleneksel görüşleri ve rutin işleri hayatlarında tercih edebilir.",
        "Riski sevmeyen, bildiği yolu bırakmayı tercih etmeyen kişiler olabilir.",
    ]
    envanter_degerlendirme_10_1 = [
        "Duygusal yaşamı renkli, farklı konularda düşünme eğilimi yüksek olabilir.",
        "İlgi alanı geniş olduğu için yeni bilgiler ile beslenebilir.",
        "Yeni işlere girişmekten hoşnut olabilir.",
    ]

    envanter_degerlendirme_11_0 = [
        "Sakindir, göze batmayan şekilde yaşamayı tercih edebilir.",
    ...
    envanter_degerlendirme_11_1 = [
        "Hareket etmeyi seven, olumlu düşünmeye eğilimli olabilir.",
    ...
    envanter_degerlendirme_12_0 = [
        "Eleştiriye tahammül seviyesi yüksek olabilir.",
    ...
    envanter_degerlendirme_12_1 = [
        "İnsanlara güveme ihtimalleri düşük olabilir. Kolayca öfkelenebilir.",
    ...
    envanter_degerlendirme_13_0 = [
        "Motivasyon ve bir iş sürecini organizme etme olasılığı düşük olabilir.",
        "Yaptığı işten kolayca sıkılabilir.",
        "Zor olan işleri ertelemeye yatkın olabilir.",
    ]
    envanter_degerlendirme_13_1 = [
        "Amaca yönelik hareket edebilir.",
        "İçsel motivasyonu yüksek olabilir.",
        "Titizlikle sonuca odaklanma eğilimi yüksektir.",
    ]

    envanter_degerlendirme_14_0 = [
        "Davranışı önceden tahmin edilebilir.",
        "Duygu durumunu kontrol edebilen kişiler olabilir.",
        "İnsanlarla etkileşimi pozitif olmaya eğilimlidir.",
    ]
    envanter_degerlendirme_14_1 = [
        "Kolaylıkla üzülebilir, duygu durumu sık sık değişebilir.",
        "Bu yüzden de davranışları tutarsız olabilir.",
        "Gerilmekten dolayı motivasyonu düşük olabilir.",
    ]

    envanter_degerlendirme_15_0 = [
        "Yeni fikirlere açık değildir.",
        "Somut düşünmeye yatkın olabilir.",
        "Sabit yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_15_1 = [
        "Olayları irdeleyebilir.",
        "Neden sonuç bağlantısı kurabilmeye yatkın olabilir.",
        "Bir olayın gelecek zamandaki avantaj ve dezavantajlarını önceden tahmin edebilir.",
    ]

    envanter_degerlendirme_16_0 = [
        "Sosyal ortamlarda girişkenlik göstermeyebilir.",
        "Fikirlerini söylemekten kaçınabilir.",
        "Başkalarıyla fikir alışverişine girmektense iç sesiyle konuşmaya eğilimlidir.",
    ]
    envanter_degerlendirme_16_1 = [
        "İletişim becerileri ve içsel motivasyonu yüksek olabilir.",
        "Sosyal becerileri gelişmiş, dominant kişilik yapısı olabilirler.",
        "Kendinden emin olmaya eğilimlidir.",
    ]

    envanter_degerlendirme_17_0 = [
        "Olumsuz düşüncelere ve şüpheci davranışlara eğilimli olabilir.",
        "Çalışma ortamlarında rekabetçi davranışlar sergileyebilir.",
        "Olumsuz durumlar karşısında fevri davranışlar sergileyebilir.",
    ]
    envanter_degerlendirme_17_1 = [
        "Sosyal ortamlarda çatışmalardan uzak kalmaya çalışır.",
    ...
    envanter_degerlendirme_18_1 = [
        "Yapılması gereken işleri ertelemeye yatkın olabilir.",
    ...
    envanter_degerlendirme_19_0 = [
        "Hedeflerine odaklanabilir.",
        "Zorluklar karşısında dayanıklıdır.",
        "Duruma uygun davranışlar sergileyebilen bir yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_19_1 = [
        "Sosyal ortamlarda kolayca incinebilen hassas bir yapıya sahip olabilir.",
    ...
    envanter_degerlendirme_20_0 = [
        "Daha çok somut faaliyetlerden ve rutin işlerden hoşlanabilir.",
    ...
    envanter_degerlendirme_20_1 = [
        "Gözlem yeteneği gelişmiş olabilir.",
    ...
    envanter_degerlendirme_21_0 = [
        "Sosyal ortamlarda neşeli, canlı, hareketli ve sıcak olmaya yatkın olabilir.",
    ...
    envanter_degerlendirme_21_1 = [
        "Sosyal ortamlarda daha sessiz kalmayı ve gözlemci olmayı tercih edebilir.",
    ...
    envanter_degerlendirme_22_0 = [
        "Öz disiplin seviyesi düşük olabilir.",
    ...
    envanter_degerlendirme_22_1 = [
        "Olaylar karşısında daha nesnel davranabilir.",
    ...
    envanter_degerlendirme_23_0 = [
        "Motivasyon seviyeleri yüksek, azimli kararlı bir şekilde çalışmaya yatkındır.",
        "Sorumluluklarını yerine getirmekte kararlıdır.",
    ]
    envanter_degerlendirme_23_1 = [
        "Kişisel hedef belirlemede zorluklar yaşabilir.",
        "Zamanını verimli şekilde kullanamayabilir.",
        "Motivasyonları düşmeye eğilimlidir.",
    ]

    envanter_degerlendirme_24_0 = [
        "Duygu durumunu genellikle kontrol edebilir.",
        "Davranışları nisbeten tahmin edilebilir.",
        "Tutarlı davranışlar sergileyebilen bir yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_24_1 = [
        "Duygu durumu kolayca değişebilir.",
        "Davranışlarında tutarsızlıklar olabilir.",
        "Gergin ortamlarda motivasyonları düşebilir.",
    ]

    envanter_degerlendirme_25_0 = [
    ...
    envanter_degerlendirme_27_1 = [
        "Sosyal ortamlarda insanlarla iletişime geçmekten hoşlanmayabilir.",
    ...
    envanter_degerlendirme_28_0 = [
        "Hedefine ulaşamak için kendilerini organize etmede güçlükler yaşayabilir.",
    ...
    envanter_degerlendirme_28_1 = [
        "Yüksek başarı motivasyonuna sahip olabilir.",
        "Hedeflerine ulaşmak için azimli ve aktif bir şekilde çalışabilir.",
        "Güvenilir ve sorumluluk sahibi olmaya yatkındır.",
    ]

    envanter_degerlendirme_29_0 = [
        "Duygu durumu kolayca değişmeyebilir.",
        "Tutarlı davranışlar sergileyebilir.",
        "Çok hassas bir yapıya sahip olmayabilir.",
        "Olaylardan kolay etkilenemeyebilir.",
        "Davranışları nisbeten önceden kestirilebilir.",
        "Güçlü bir yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_29_1 = [
        "Duygu durumu kolayca değişebilir.",
        "Anlık duruma göre duruma göre duygusal tutarsızlıklar yaşabilir.",
        "Hassas bir yapıya sahip olabilir.",
        "Kolayca incinebilir.",
        "Olaylardan kolay etkilenebilir.",
        "Kararsız ve kendilerini suçlamaya yatkın olabilir.",
    ]

    envanter_degerlendirme_30_0 = [
        "Başkalarından ziyade kendine eğilimi yüksek olabilir.",
    ...
    envanter_degerlendirme_30_1 = [
        "Duygulu, hassas, ince bir yapıya sahip olabilir.",
        "Duygularını yoğun şekilde yaşayabilir.",
        "Empati seviyeleri yüksektir.",
        "Estetik ve sanata yatkın olabilir.",
    ]

    envanter_degerlendirme_31_0 = [
        "Sosyal ortamlara kolayca uyum sağlayabilir.",
    ...
    envanter_degerlendirme_31_1 = [
        "Sosyal ortamlarda ön plana çıkmayı tercih etmeyebilir.",
    ...
    envanter_degerlendirme_32_0 = [
        "Eleştirilmekten hoşlanmayabilir.",
        "Başkalarına karşı hoşgörü gösterme konusunda güçlük yaşayabilir.",
        "Kin tutmaya meyilli olabilir.",
        "Kibirli davranışlar sergileyebilir.",
    ]
    envanter_degerlendirme_32_1 = [
        "Yeni girdikleri ortama kolayca uyum sağlayabilir.",
        "Alçakgönüllü, pozitif ve girişken yapıya sahip olabilir.",
        "Sorunlar karşısında pozitif tavır sergileyebilir.",
    ]

    envanter_degerlendirme_33_0 = [
        "Hedeflerine ulaşma konusunda sıkıntılar yaşayabilir.",
    ...
    envanter_degerlendirme_33_1 = [
        "Amaçlarına ulaşmak için gerekli içsel motivasyonları yüksek olabilir.",
        "Hedefler koyabilen ve gerçekleştirmek için çaba harcayan bir yapıya sahip olabilir.",
    ]

    envanter_degerlendirme_34_0 = [
        "Duygu durumları kolayca değişebilir.",
        "Anlık ruh haline göre davranabilir.",
        "Bu nedenle problemlerin çözümünde sakin kalamayabilir.",
        "Tutarsız, değişen duygusal yapı gösterebilir.",
    ]
    envanter_degerlendirme_34_1 = [
        "Olaylar karşısında mantıklı çözümler bulabilir.",
        "Olaylara objektif bakabilir.",
        "Probleri büyütmekten çok çözmeye odaklı olabilir.",
        "Davranışlar nisbeten önceden kestirilebilir.",
        "Tutarlı kişiliğe sahip olabilir.",
    ]

    envanter_degerlendirme_35_0 = [
        "Olaylara farklı yaklaşım tarzı sergileyebilir.",
        "Rutin işlerden sıkılmaya yatkın olabilir.",
        "Farklı deneyimler yaşamaya eğilimli olabilir.",
        "Enerji seviyesi yüksek olabilir.",
    ]
    envanter_degerlendirme_35_1 = [
        "Yetkin olduğu işleri yapmayı tercih edebilir.",
        "Çatışma ortamından kaçınmayı tercih edebilir.",
        "Olaylara farklı yaklaşımlar sergileyemeyebilir.",
        "Belirsizliği sevmeyebilir.",
        "Her yeniliği bir risk olarak görebilir.",
    ]

    envanter_degerlendirme_36_0 = [
        "Kalabalık ortamlardan çok sakin ortamları tercih edebilir.",
    ...
    envanter_degerlendirme_36_1 = [
        "Sosyal ortamlarda konuşkan, neşeli, hevesli ve canlı olabilir.",
    ...
    envanter_degerlendirme_37_0 = [
        "Sosyal ortamlarda ılımlı, anlayışlı tavırlar sergiler.",
        ...
        "Eleştrilmeye açık olabilir.",
        "Önyargısız ve hoşgörülü bir yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_37_1 = [
        "Çabuk sinirlenebilen, önyargılı bir yapıya sahip olabilir.",
        "Peşin hükümlü bir yapıya sahip olduklarından olumsuz tepkilerini kolayca ortaya koyabilir.",
        "Eleştrilmekten hoşlanmayabilir.",
        "Zaman zaman insanlara karşı kırıcı olabilir.",
    ]

    envanter_degerlendirme_38_0 = [
        "İçsel motivasyonu düşük olabilir.",
    ...
    envanter_degerlendirme_39_0 = [
        "Sosyal ortamlarda pozitif olmaya yatkındır.",
        "Durumu uygun davranışlar sergileyebilir.",
        "Sorgulayan ve güvenilir bir yapıya sahip olabilir.",
    ]
    envanter_degerlendirme_39_1 = [
        "Duygu durumu sıkça değişiklik gösterebilir.",
    ...
    envanter_degerlendirme_40_0 = [
        "Fikirlerle uğraşmaktansa somut faaliyetlerden daha fazla zevk alabilir.",
        "Entelektüel faaliyetlere pek ilgi göstermeyebilir.",
    ]
    envanter_degerlendirme_40_1 = [
        "Analitik düşünce yapısına sahip olabilir.",
        "Analiz yapma yetisi yüksektir.",
        "Soyut düşünebilir.",
        "Kendini geliştirmeye eğilimli bir yapıya sahip olabilir.",
        "Durumlara farklı açılardan yaklaşabilir.",
    ]

    envanter_degerlendirme_41_0 = [
        "Duygulu, ince ve sanatçı ruhlu bir yapıya sahip olabilir.",
        "Kendinin ve başkalarının duygularını önemseme eğilimi yüksek olabilir.",
    ]
    envanter_degerlendirme_41_1 = [
        "Nesnel düşünme eğilimi yüksek olabilir.",
    ...
    envanter_degerlendirme_42_0 = [
        "Grup çalışmasından çok bireysel çalışmayı tercih edebilir.",
    ...
    envanter_degerlendirme_42_1 = [
        "Başkalarını düşünen, empati düzeyi yüksek bir yapıya sahip olabilir.",
    ...
    envanter_degerlendirme_43_0 = [
        "Planlı çalışma eğilimi yüksek olabilir.",
        "Konsantrasyonu yüksek olabilir.",
        "Otokontrolü yüksek olabilir.",
        "Başladığı işi bitirme eğilimi yüksek olabilir.",
    ]
    envanter_degerlendirme_43_1 = [
        "Otokontrol seviyesi düşük olabilir.",
        "Bir işi yaparken çok çabuk sıkılabilir.",
        "Detayları gözden kaçırmaya eğilimli olabilir.",
    ]

    envanter_degerlendirme_44_0 = [
        "Hayal gücü sınırlı, gerçi bir yapıya sahip olabilir.",
        "Mantıklı hareket etme eğilimi yüksek olabilir.",
        "Fikirleri sabit olabilir.",
        "Düşünceleri kolay kolay değişmez önyargılı olabilir.",
    ]
    envanter_degerlendirme_44_1 = [
        "Sanatsal ve estetik bakış açısı gelişmiş olabilir.",
    ...
    if soru <= 3:
        envanter_analiz += envanter_degerlendirme_1_0[
            rd.randint(0, len(envanter_degerlendirme_1_0) - 1)
        ]
    elif soru >= 6:
        envanter_analiz += envanter_degerlendirme_1_1[
            rd.randint(0, len(envanter_degerlendirme_1_1) - 1)
        ]
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_2_0[
                rd.randint(0, len(envanter_degerlendirme_2_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_2_1[
                rd.randint(0, len(envanter_degerlendirme_2_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_3_0[
                rd.randint(0, len(envanter_degerlendirme_3_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_3_1[
                rd.randint(0, len(envanter_degerlendirme_3_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_4_0[
                rd.randint(0, len(envanter_degerlendirme_4_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_4_1[
                rd.randint(0, len(envanter_degerlendirme_4_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_5_0[
                rd.randint(0, len(envanter_degerlendirme_5_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_5_1[
                rd.randint(0, len(envanter_degerlendirme_5_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_6_0[
                rd.randint(0, len(envanter_degerlendirme_6_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_6_1[
                rd.randint(0, len(envanter_degerlendirme_6_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_7_0[
                rd.randint(0, len(envanter_degerlendirme_7_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_7_1[
                rd.randint(0, len(envanter_degerlendirme_7_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_8_0[
                rd.randint(0, len(envanter_degerlendirme_8_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_8_1[
                rd.randint(0, len(envanter_degerlendirme_8_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_9_0[
                rd.randint(0, len(envanter_degerlendirme_9_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_9_1[
                rd.randint(0, len(envanter_degerlendirme_9_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_10_0[
                rd.randint(0, len(envanter_degerlendirme_10_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_10_1[
                rd.randint(0, len(envanter_degerlendirme_10_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_11_0[
                rd.randint(0, len(envanter_degerlendirme_11_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_11_1[
                rd.randint(0, len(envanter_degerlendirme_11_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_12_0[
                rd.randint(0, len(envanter_degerlendirme_12_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_12_1[
                rd.randint(0, len(envanter_degerlendirme_12_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_13_0[
                rd.randint(0, len(envanter_degerlendirme_13_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_13_1[
                rd.randint(0, len(envanter_degerlendirme_13_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_14_0[
                rd.randint(0, len(envanter_degerlendirme_14_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_14_1[
                rd.randint(0, len(envanter_degerlendirme_14_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_15_0[
                rd.randint(0, len(envanter_degerlendirme_15_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_15_1[
                rd.randint(0, len(envanter_degerlendirme_15_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_16_0[
                rd.randint(0, len(envanter_degerlendirme_16_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_16_1[
                rd.randint(0, len(envanter_degerlendirme_16_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_17_0[
                rd.randint(0, len(envanter_degerlendirme_17_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_17_1[
                rd.randint(0, len(envanter_degerlendirme_17_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_18_0[
                rd.randint(0, len(envanter_degerlendirme_18_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_18_1[
                rd.randint(0, len(envanter_degerlendirme_18_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_19_0[
                rd.randint(0, len(envanter_degerlendirme_19_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_19_1[
                rd.randint(0, len(envanter_degerlendirme_19_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_20_0[
                rd.randint(0, len(envanter_degerlendirme_20_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_20_1[
                rd.randint(0, len(envanter_degerlendirme_20_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_21_0[
                rd.randint(0, len(envanter_degerlendirme_21_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_21_1[
                rd.randint(0, len(envanter_degerlendirme_21_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_22_0[
                rd.randint(0, len(envanter_degerlendirme_22_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_22_1[
                rd.randint(0, len(envanter_degerlendirme_22_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_23_0[
                rd.randint(0, len(envanter_degerlendirme_23_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_23_1[
                rd.randint(0, len(envanter_degerlendirme_23_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_24_0[
                rd.randint(0, len(envanter_degerlendirme_24_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_24_1[
                rd.randint(0, len(envanter_degerlendirme_24_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_25_0[
                rd.randint(0, len(envanter_degerlendirme_25_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_25_1[
                rd.randint(0, len(envanter_degerlendirme_25_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_26_0[
                rd.randint(0, len(envanter_degerlendirme_26_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_26_1[
                rd.randint(0, len(envanter_degerlendirme_26_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_27_0[
                rd.randint(0, len(envanter_degerlendirme_27_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_27_1[
                rd.randint(0, len(envanter_degerlendirme_27_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_28_0[
                rd.randint(0, len(envanter_degerlendirme_28_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_28_1[
                rd.randint(0, len(envanter_degerlendirme_28_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_29_0[
                rd.randint(0, len(envanter_degerlendirme_29_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_29_1[
                rd.randint(0, len(envanter_degerlendirme_29_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_30_0[
                rd.randint(0, len(envanter_degerlendirme_30_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_30_1[
                rd.randint(0, len(envanter_degerlendirme_30_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_31_0[
                rd.randint(0, len(envanter_degerlendirme_31_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_31_1[
                rd.randint(0, len(envanter_degerlendirme_31_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_32_0[
                rd.randint(0, len(envanter_degerlendirme_32_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_32_1[
                rd.randint(0, len(envanter_degerlendirme_32_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_33_0[
                rd.randint(0, len(envanter_degerlendirme_33_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_33_1[
                rd.randint(0, len(envanter_degerlendirme_33_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_34_0[
                rd.randint(0, len(envanter_degerlendirme_34_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_34_1[
                rd.randint(0, len(envanter_degerlendirme_34_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_35_0[
                rd.randint(0, len(envanter_degerlendirme_35_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_35_1[
                rd.randint(0, len(envanter_degerlendirme_35_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_36_0[
                rd.randint(0, len(envanter_degerlendirme_36_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_36_1[
                rd.randint(0, len(envanter_degerlendirme_36_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_37_0[
                rd.randint(0, len(envanter_degerlendirme_37_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_37_1[
                rd.randint(0, len(envanter_degerlendirme_37_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_38_0[
                rd.randint(0, len(envanter_degerlendirme_38_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_38_1[
                rd.randint(0, len(envanter_degerlendirme_38_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_39_0[
                rd.randint(0, len(envanter_degerlendirme_39_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_39_1[
                rd.randint(0, len(envanter_degerlendirme_39_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_40_0[
                rd.randint(0, len(envanter_degerlendirme_40_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_40_1[
                rd.randint(0, len(envanter_degerlendirme_40_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_41_0[
                rd.randint(0, len(envanter_degerlendirme_41_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_41_1[
                rd.randint(0, len(envanter_degerlendirme_41_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_42_0[
                rd.randint(0, len(envanter_degerlendirme_42_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_42_1[
                rd.randint(0, len(envanter_degerlendirme_42_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_43_0[
                rd.randint(0, len(envanter_degerlendirme_43_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_43_1[
                rd.randint(0, len(envanter_degerlendirme_43_1) - 1)
            ]
        )
    else:
    ...
    if soru <= 3:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_44_0[
                rd.randint(0, len(envanter_degerlendirme_44_0) - 1)
            ]
        )
    elif soru >= 6:
        envanter_analiz += (
            " "
            + envanter_degerlendirme_44_1[
                rd.randint(0, len(envanter_degerlendirme_44_1) - 1)
            ]
        )
    else:
...
def danisman_analiz_olustur(ogrenci):
    ...
    if len(arada_kalanlar) > 0:
        ...
        arada_kalan_mesaj += (
            "ve "
            + arada_kalanlar[len(arada_kalanlar) - 1]
            + " numaralı sorulara 4 ve 5 verilmiş."
        )
        p = document.add_paragraph()
...
def mail_gonder(ogr_adi, ogr_maili):
    ...
    body = "Sayın {}, Kariyer Geliştirme Koordinatörlüğü'nde tamamlamış olduğunuz kişilik envanterinin analizi ektedir. DanışmanAI hakkındaki görüşleriniz bizim için çok kıymetlidir. Lütfen anketimize katılın. https://forms.gle/xmevKHZVWfVpfE8V7 formu doldurduktan sonra çekiliş için hak kazanmış olacaksınız.".format(
        ogr_adi
    )
...
def mail_gonder_yetkili(ogr_adi, mail_adresi):
    file_path = []
    user = "kariyer@sakarya.edu.tr"  # Email userID
    password = st.secrets["kariyer_sifre"]  # Email password
    from_addr = "kariyer@sakarya.edu.tr"
    recipients_addr = mail_adresi
...
def mail_gonder_fuar(ogr_adi, ogr_maili):
    file_path = []
    user = "kariyer@sakarya.edu.tr"  # Email userID
    password = st.secrets["kariyer_sifre"]  # Email password
    ...
    subject = "5FE Kişilik Envanteri Analizi - {}".format(ogr_adi)
    body = (
        "Doldurmuş olduğunuz envanter ektedir. Standımıza göstermiş olduğunuz ilgi için teşekkür ederiz.\n"
...
def versiyon():
    st.caption(
        """
                ...
                ver 2.0.0_beta<br/><font size="2">build 01012025.2141</font>
                </p>
            """,
        unsafe_allow_html=True,
    )
